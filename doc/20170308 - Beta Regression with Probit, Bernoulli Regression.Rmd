...
stan_code <- "functions {
    ...
    real cpr_pred_rng(real[] season, real[] beta, real lambda, real intercept,
                    int month, real cato, real hpa, real lockin,
